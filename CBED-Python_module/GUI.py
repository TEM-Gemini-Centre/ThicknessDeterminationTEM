...
theta1_label.grid(row =1, column=0)
theta1 = Entry(root, width = 20)
theta1.grid(row =2, column=0)


theta2_label = Label(root, text = 'Theta2:')
theta2_label.grid(row =3, column=0)
theta2 = Entry(root, width = 20)
theta2.grid(row =4, column=0)


theta3_label = Label(root, text = 'Theta3:')
theta3_label.grid(row =5, column=0)
theta3 = Entry(root, width = 20)
theta3.grid(row =6, column=0)
...
d_kik_label.grid(row =7, column=0, pady = 15)
d_kik = Entry(root, width = 20)
d_kik.bind('<Return>',run_CBEDAnalysis)
d_kik.grid(row =8, column=0)
...
wavelengthTEM_label = Label(root, text = 'Wavelength [Å]: ')
wavelengthTEM_label.grid(row =2, column=1)
wavelengthTEM = Entry(root, width = 20)
wavelengthTEM.insert(END, wavelength_TEM_200kV)
wavelengthTEM.grid(row =3, column=1)


d_latticePlane_label = Label(root, text = 'Latticeplane distance [nm]:')
d_latticePlane_label.grid(row =4, column=1)
d_latticePlane = Entry(root, width = 20)
d_latticePlane.insert(END, d_Al_220)
d_latticePlane.grid(row =5, column=1)
